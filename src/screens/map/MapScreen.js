  ...
  return (
    <div className='big-box-map'>
      <div>
        ...
        {images[12] && <img src={`${images[12]}`} alt={images[12]} />}
      </div>
      <div>
        <img src={`${images[3]}`} alt={images[3]} />
        <img src={`${images[4]}`} alt={images[4]} />
        <img src={`${images[5]}`} alt={images[5]} />
        {images[13] && <img src={`${images[13]}`} alt={images[13]} />}
      </div>
      <div>
        <img src={`${images[6]}`} alt={images[6]} />
        <img src={`${images[7]}`} alt={images[7]} />
        <img src={`${images[8]}`} alt={images[8]} />
        {images[14] &&<img src={`${images[14]}`} alt={images[14]} />}
      </div>
      <div>
      {images[9] &&<img src={`${images[9]}`} alt={images[9]} />}
      {images[10] &&<img src={`${images[10]}`} alt={images[10]} />}
      {images[11] &&<img src={`${images[11]}`} alt={images[11]} />}
      {images[12] &&<img src={`${images[12]}`} alt={images[12]} />}
