...
import {PlansImgs, PlansBast, PlansRing, PlansBrazal, IntroComponents} from "../../../../component"
...
function Intro() {
  ...
  return (
    <div  className='dongionsdetail-box' data-aos="fade-in">
      ...
      <IntroComponents titulo={"Te explico..."} 
        texto1={"Estás entrando en un mundo retorcido, complejo y lleno de posibilidades fruto de años de esfuerzo, reflexión y trabajo personal. El primer mundo o plano sobre el que he trabajado se llama BELERON y el juego se desarolla en sus vastos reinos, variopintos pueblos, sin fin de clanes, personajes imponentes e historias enrevesadas, en las que las cosas no son lo que parecen, menos cuando son tanto lo que parecenque no podrían ser otra cosa. Básicamente me gusta sorprender a los jugadores."}
        ...
        texto3={"Me gusta empezar todas las partidas con los jugadores sin recordar cómo han llegado allí o qué estan haciendo, sea cual sea la situación y que una parte del juego sea averiguar qué ha pasado e intentar recuperar los recuerdos y reconstruir su pasado."}     
      />
