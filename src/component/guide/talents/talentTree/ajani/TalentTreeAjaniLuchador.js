  ...
  return (
    <div className='talent-tree-box'>
      <div className='talent-tree-row'>
        ...
        <TalentTreeButtonComponent points={pointsData.ajani.luchador[3]} nombre={"Al fin veces seguidas a un jugador, te come el culo"} btnWidth={"500px"} btnHeight={"60px"} btn={"btn-luchador"} talentToSelect={"talent-to-select"} />
        <TalentTreeButtonComponent empty btnWidth={"10%"} />
      </div>
