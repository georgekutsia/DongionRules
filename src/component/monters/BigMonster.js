...
function BigMonster() {
  ...
  return (
    <div className='big-monster-scroller'>
        ...
        <div style={{borderRadius:"5px", backgroundColor: `rgb(${e}, ${g}, ${g})`, margin:"2px"}}>
            <Link className='link-name-monster' onClick={()=> setShowMonster6(!showMonster6)}>Monstraco 6</Link>
              {showMonster6 &&
        ...
        <div style={{borderRadius:"5px", backgroundColor: `rgb(${e}, ${e}, ${g})`, margin:"2px"}}>
            <Link className='link-name-monster' onClick={()=> setShowMonster7(!showMonster7)}>Monstraco 7</Link>
              {showMonster7 &&
